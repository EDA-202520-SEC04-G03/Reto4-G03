...
def new_vertex(key, value):
    ...
    """
    # CORRECCIÓN: Cambia 0 por un número mayor (por ejemplo, 10)
    # para que el mapa tenga una capacidad inicial válida
    vertex = {"key": key, "value": value, "adjacents": mp.new_map(10, 0.5)}
    return vertex
